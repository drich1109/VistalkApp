    ...
    <aside class="navbar {isExpanded ? 'expanded' : 'collapsed'}">
        ...
        <div class="dropdown-menu">
            <nav class="navigation">
                ...
                <a class="nav-link {activePage === '/question' ? 'active' : ''}" on:click={() => navigateAndClose('/question')}>
                ...
                <a class="nav-link {activePage === '/questionTemplate' ? 'active' : ''}" on:click={() => navigateAndClose('/questionTemplate')}>
