<script lang="ts">
    ...
    import { getItemType, savePowerup } from './repo';
    ...
    <div 
      ...
      <div class="flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
        ...
        >
          ...
          <form class="mt-5">
            <div>
              ...
              <div class="mt-2">
                ...
                <input bind:value={powerUp.name} placeholder="VCoin Price" type="text" class="block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
            </div>

            <div class="mt-2">
                <label for="username" class="block text-sm text-black capitalize dark:text-black">Item Description</label>
                <input bind:value={powerUp.description}   placeholder="VCoin Price" type="text" class="block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
            </div>

              <div class="mt-2">
                <label for="username" class="block text-sm text-black capitalize dark:text-black">VCoin Price</label>
              <input bind:value={powerUp.vcoinPrice}  placeholder="VCoin Price" type="number" class="block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
            </div>
            ...
            <div class="mt-2">
              ...
              <input  placeholder="VCoin Price" type="text" class="block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
            </div>
          ...
          <div class="mt-2">
              <div class="flex">
                  <label class="bg-black p-2 text-white text-sm rounded-md flex items-justify mr-2 cursor-pointer" for="file">Upload file<svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24"><path fill="currentColor" d="M11 16V7.85l-2.6 2.6L7 9l5-5l5 5l-1.4 1.45l-2.6-2.6V16zm-5 4q-.825 0-1.412-.587T4 18v-3h2v3h12v-3h2v3q0 .825-.587 1.413T18 20z"/></svg></label>
                  <input type="file" class="file-input" accept=".mp3"style="visibility: hidden"/>
              </div>
          </div>
          {/if}
          ...
          {#if currentType == 3}
            ...
            <div class="mt-2">
                ...
                <input  placeholder="VCoin Price" type="number" class="block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
            </div>
