    ...
    <div class="modal-background h-[35em] w-[62em] mt-16">
        <div class="absolute inset-0 flex flex-col items-center justify-center gap-4">
          ...
          <div class="flex items-center border border-white rounded-lg px-2 py-1 gap-2">
            ...
            <input class="bg-transparent outline-none text-gray-600 placeholder-[#000000] pr-2" type="text" name="" id="" placeholder="Enter Username" bind:value={userName}>
          </div>
          <div class="flex items-center border border-white rounded-lg px-2 py-1 gap-2">
            <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <input class="bg-transparent outline-none text-gray-600 placeholder-[#000000] pr-2" type="password" name="" id="" placeholder="Enter Password"  bind:value={password}>
          </div>
        ...
        <p class="text-white text-md">Forget password?</p>
        </div>
    </div>
</div>
<style>
  .modal-background {
      background-image: url('LoginModal.png'); /* Replace with your image path */
