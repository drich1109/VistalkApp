      ...
      <div class="absolute inset-0 flex flex-col items-center justify-center gap-4 z-10">
        ...
        {/if}
          <div class="flex items-center border border-white rounded-lg px-2 py-1 gap-2">
              ...
              <input class="bg-transparent outline-none text-[#000000] placeholder-gray-500 placeholder-opacity-100 pr-2" type="text" placeholder="Enter Username" bind:value={userName}>
          </div>
          ...
          <div class="flex items-center border border-white rounded-lg px-2 py-1 gap-2">
              ...
              <input class="bg-transparent outline-none text-[#000000] placeholder-gray-500 placeholder-opacity-100 pr-2" type="password" placeholder="Enter Password" bind:value={password}>
          </div>
          ...
          <p class="text-white text-md">Forgot password?</p>
      </div>
  </div>
</div>
