...
<div class="flex flex-wrap gap-6 mt-6 justify-center">
    ...
    <button on:click={() => toggleButton(section.sectionId)} class="bg-white rounded-xl py-4 px-4 flex-grow  transform hover:scale-105 transition-transform duration-300 shadow-lg">
